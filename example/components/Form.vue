        ...
        <scrollview>
            ...
            <div class="demo-body">
                ...
                <div class="demo-item">
                    <h2>Textarea</h2>
                    <div class="demo-content">
                        <p class="demo-describe">文本域</p>
                        <z-textarea placeholder="请输入个人简介"></z-textarea>
                    </div>
                    <div class="demo-content">
                        <p class="demo-describe">字数统计</p>
                        <z-textarea placeholder="请输入个人简介" :chrNum="10" v-model="text"></z-textarea>
                    </div>
                </div>
                <div class="demo-item">
                    <h2>Switch</h2>
